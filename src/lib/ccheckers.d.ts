...
* @param {string} data
*/
export function request_load(data: string): void;
/**
* @returns {Promise<string>}
*/
export function request_store(): Promise<string>;
/**
* @param {number} mode
*/
export function signal_reset(mode: number): void;
/**
...
export interface InitOutput {
  ...
  readonly request_load: (a: number, b: number) => void;
  readonly request_store: () => number;
  readonly signal_reset: (a: number) => void;
  readonly main_web: () => number;
  ...
  readonly wasm_bindgen__convert__closures__invoke1_mut__h0e1ec0f56701b563: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h24f11f89877d7380: (a: number, b: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h0b0795e758daf49b: (a: number, b: number, c: number, d: number) => void;
}
