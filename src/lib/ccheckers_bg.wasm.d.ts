...
export function request_load(a: number, b: number): void;
export function request_store(): number;
export function signal_reset(a: number): void;
export function main_web(): number;
...
export function wasm_bindgen__convert__closures__invoke1_mut__h0e1ec0f56701b563(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h24f11f89877d7380(a: number, b: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h0b0795e758daf49b(a: number, b: number, c: number, d: number): void;
